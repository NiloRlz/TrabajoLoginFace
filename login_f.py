...
def verificacion_login():
    ...
    if log_usuario in lista_archivos:   #Comparamos los archivos con el que nos interesa
        ...
        if log_contra in verificacion:
            ...
            Label(pantalla2, text = "Inicio de Sesion Exitoso", fg = "blue", font = ("Calibri",11)).pack()
        else:
...
def login():
    ...
    pantalla2.title("Iniciar Sesion")
...
def pantalla_principal():
    ...
    pantalla = Tk()
    pantalla.configure(bg="#DCDBDB") 
    #pantalla = label(bg = "#80B0FF")
    pantalla.geometry("500x350")  #Asignamos el tamaño de la ventana 
    pantalla.title("TRABAJO SEMANAL")       #Asignamos el titulo de la pantalla
    Label(text = "Login con FaceId", bg = "#80B0FF", width = "300", height = "2", font = ("Verdana", 13)).pack() #Asignamos caracteristicas de la ventana
    
#Vamos a Crear los Botones 
    
    Label(text = "").pack()  #Creamos el espacio entre el titulo y el primer boton
    Button(text = "Iniciar Sesion", height = "2", width = "30", bg = "#5062FD", fg="white", command = login).pack()
    Label(text = "").pack() #Creamos el espacio entre el primer boton y el segundo boton
    Button(text = "Registro", height = "2", width = "30", bg = "#5062FD", fg="white", command = registro).pack()
